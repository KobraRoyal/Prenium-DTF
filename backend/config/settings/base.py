...
SENDCLOUD_INTEGRATION_ID = env_int("SENDCLOUD_INTEGRATION_ID", 0)
...
PASSWORD_RESET_RATE_LIMIT_MAX_ATTEMPTS = env_int("PASSWORD_RESET_RATE_LIMIT_MAX_ATTEMPTS", 5)
PASSWORD_RESET_RATE_LIMIT_WINDOW_SECONDS = env_int("PASSWORD_RESET_RATE_LIMIT_WINDOW_SECONDS", 3600)
PASSWORD_RESET_EMAIL_MAX_ATTEMPTS = env_int("PASSWORD_RESET_EMAIL_MAX_ATTEMPTS", 3)
PASSWORD_RESET_EMAIL_WINDOW_SECONDS = env_int("PASSWORD_RESET_EMAIL_WINDOW_SECONDS", 3600)
PASSWORD_RESET_TIMEOUT = env_int("PASSWORD_RESET_TIMEOUT", 86400)
SUPPORT_CONTACT_EMAIL = os.environ.get("SUPPORT_CONTACT_EMAIL", "").strip()
PROSPECT_RATE_LIMIT_MAX_ATTEMPTS = env_int("PROSPECT_RATE_LIMIT_MAX_ATTEMPTS", 5)
PROSPECT_RATE_LIMIT_WINDOW_SECONDS = env_int("PROSPECT_RATE_LIMIT_WINDOW_SECONDS", 3600)
PROSPECT_RATE_LIMIT_TRUST_X_FORWARDED_FOR = env_bool(
    "PROSPECT_RATE_LIMIT_TRUST_X_FORWARDED_FOR",
    False,
)
GANG_SHEET_UPLOAD_RATE_LIMIT_MAX_REQUESTS = env_int(
    "GANG_SHEET_UPLOAD_RATE_LIMIT_MAX_REQUESTS",
    30,
)
GANG_SHEET_UPLOAD_RATE_LIMIT_WINDOW_SECONDS = env_int(
