...
EMAIL_CHANGE_MAX_AGE_SECONDS = env_int("EMAIL_CHANGE_MAX_AGE_SECONDS", 86400)
EMAIL_CHANGE_RATE_LIMIT_MAX_ATTEMPTS = env_int("EMAIL_CHANGE_RATE_LIMIT_MAX_ATTEMPTS", 5)
