...
class StudioPolishUITests(SimpleTestCase):
    def test_studio_polish_follows_the_editor_component(self) -> None:
        ...
        self.assertIn("max-height: calc(min(44rem, 100dvh - 1.25rem) - 10.5rem) !important", entry)
        ...
        self.assertIn("gang-studio-pay-dialog__footer", polish)
        self.assertIn("gang-studio-order-recap", polish)
        self.assertIn("gang-studio-pay__caption", polish)
        self.assertIn("gang-studio-pay-dialog__lede", polish)
        self.assertIn("grid-template-columns: 2.75rem 2.75rem minmax(0, 1fr)", polish)
        self.assertIn(".product-date-picker__popover", polish)
    ...
    def test_final_step_uses_one_confirm_cta(self) -> None:
        ...
        self.assertIn("Je commande", dialog)
        self.assertIn("Confirmer la commande", dialog)
        self.assertIn("Livraison à choisir", checkout)
        self.assertIn("Production", checkout)
        self.assertNotIn("data-studio-pay-shipping", checkout)
        self.assertIn("data-studio-order-recap", dialog)
        self.assertIn("data-studio-pay-shipping", dialog)
        self.assertNotIn("Payer maintenant", dialog)
        self.assertNotIn("Confirmer et régler", dialog)
        self.assertNotIn("Confirmer et payer", checkout)
        self.assertNotIn("Valider la commande", checkout)
        self.assertIn("aucun paiement en ligne", dialog)
        self.assertIn("data-studio-encours-hint", dialog)
        self.assertIn("data-studio-dialog-mode", dialog)
        self.assertIn("data-studio-pickup-note", dialog)
        self.assertIn("Le règlement s’ouvre après confirmation.", dialog)
        ...
        self.assertIn("function studioRecapTotals", editor_js)
        self.assertIn("data-shipping-amount", shipping)
