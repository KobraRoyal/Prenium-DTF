...
class PortalUiCoherenceTests(SimpleTestCase):
    ...
    def test_b2b_order_project_flow_reuses_portal_htmx_contracts(self) -> None:
        ...
        self.assertIn("contour bleu en pointillés", validation_panel)
        self.assertIn("contour bleu en pointillés", editor)
        self.assertIn("Taille", validation_panel)
        self.assertIn("limites du fichier", validation_panel)
        ...
        self.assertIn("Nouvelle commande", dashboard)
