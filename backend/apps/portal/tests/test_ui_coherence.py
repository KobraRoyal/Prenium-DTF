...
class PortalUiCoherenceTests(SimpleTestCase):
    ...
    def test_landing_impeccable_accessibility_and_visual_contracts(self) -> None:
        ...
        self.assertIn("mentions-legales", template_source("shop/partials/landing_footer.html"))
        self.assertIn("politique-confidentialite", template_source("shop/partials/landing_footer.html"))
    ...
    def test_portal_header_uses_role_focused_labels(self) -> None:
        ...
        self.assertIn(">Accueil</a>", client_nav)
    ...
    def test_account_and_gang_sheet_libraries_use_task_focused_layouts(self) -> None:
        ...
        self.assertIn("portal:privacy", account_rail)
    ...
    def test_b2b_order_project_flow_reuses_portal_htmx_contracts(self) -> None:
        ...
        self.assertIn("b2b-project-checkout-bar__meta", summary)
        ...
        self.assertIn("client-dashboard-head", dashboard)
        self.assertIn("client-dashboard-board", dashboard)
        self.assertIn("client-dashboard-volume", dashboard)
        self.assertIn("client-dashboard-aside", dashboard)
        self.assertIn(">Encours</h2>", dashboard)
        self.assertIn("can_view_account_finance", dashboard)
        self.assertIn("client-dashboard-list", dashboard)
        self.assertIn("listed_projects", dashboard)
        self.assertIn("listed_orders", dashboard)
        self.assertIn("client_volume_discount.html", dashboard)
        self.assertNotIn("rounded-xl", dashboard)
        self.assertNotIn("ui_orders_table", dashboard)
        self.assertNotIn("ui_order_projects_table", dashboard)
