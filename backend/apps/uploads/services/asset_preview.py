        ...
        try:
            with pymupdf.open(stream=content, filetype="pdf") as document:
                ...
                return RenderedAssetPreview(
                    image=image,
                    format_name=label,
                    source_width=int(source_metrics.width_px or image.width or 1),
                    source_height=int(source_metrics.height_px or image.height or 1),
                    ...
                    metadata={
                        ...
                        "embedded_width_px": source_metrics.width_px,
                        "embedded_height_px": source_metrics.height_px,
                        "render_width_px": int(image.width),
                        "render_height_px": int(image.height),
